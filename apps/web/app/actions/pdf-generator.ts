...
`;
    ...
    const fontPath = join(process.cwd(), 'node_modules/pdfjs-dist/standard_fonts/LiberationSans-Regular.ttf');
    const fontBuffer = readFileSync(fontPath);
    const doc = new PDFDocument();
    doc.registerFont('Sans', fontBuffer);
    ...
    doc.font('Sans').fontSize(12).text(textContent);
    doc.end();
